	...
	<div id="slider1" class="rev_slider"  data-version="5.0">
		<ul>
			...
			<li data-transition="fade">
				<img src="<?php echo site_url('assets/images/slider/1.jpg') ?>"  alt="" width="1920" height="700" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
				...
				<div class="tp-caption  tp-resizeme"
					 ...
					 data-start="700">
					<div class="slide-content-box">
						<h2>Provide Business Consalting</h2>
					</div>
				</div>
				<div class="tp-caption  tp-resizeme"
					 data-x="left" data-hoffset="55"
			...
			<li data-transition="fade">
				<img src="<?php echo site_url('assets/images/slider/2.jpg');?>"  alt="" width="1920" height="700" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
				...
				<div class="col-md-6 col-xs-12">
					<div class="item">
						<figure class="image-box">
							<img src="<?php echo site_url('assets/images/background/about-1.jpg')?>" alt="" class="img-responsive">
						</figure>
					</div>
				</div>
				<div class="col-md-6 col-xs-12">
					<div class="item clearfix">
						...
						<div class="content-box">
							<h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam praesentium, distinctio dicta molestias dignissimos.</h4>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="single-features">
						<div class="media">
							<img class="mr-3" src="<?php echo site_url('assets/images/icons/leader.png')?>" alt=" image">
				...
				<div class="col-md-4">
					<div class="single-features">
						<div class="media">
							<img class="mr-3" src="<?php echo site_url('assets/images/icons/world-map.png')?>" alt="image">
							<div class="media-body">
				...
				<div class="col-md-4">
					<div class="single-features">
						<div class="media">
							<img class="mr-3" src="<?php echo site_url('assets/images/icons/money.png')?>" alt="Generic placeholder image">
							<div class="media-body">
		...
		<div class="row clearfix">
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="single-service-item">
					...
					<div class="service-icon">
						<img src="<?php echo site_url('assets/images/icons/service-1.png')?>" alt="">
					</div>
					<div class="service-text">
						<h4><a href="service-single.html">Business Services Consulting</a></h4>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="single-service-item">
					...
					<div class="service-left-bg"></div>
					<div class="service-icon">
						<img src="<?php echo site_url('assets/images/icons/service-2.png')?>" alt="">
					</div>
					<div class="service-text">
						<h4><a href="service-single.html">Energy Environment Consulting</a></h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem dolorem dicta libero veritatis reiciendis quis pariatur magni.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="single-service-item">
					...
					<div class="service-left-bg"></div>
					<div class="service-icon">
						<img src="<?php echo site_url('assets/images/icons/service-3.png')?>" alt="">
					</div>
					<div class="service-text">
						<h4><a href="service-single.html">Consumer Products Consulting</a></h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem dolorem dicta libero veritatis reiciendis quis pariatur magni.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="single-service-item">
					...
					<div class="service-left-bg"></div>
					<div class="service-icon">
						<img src="<?php echo site_url('assets/images/icons/service-4.png')?>" alt="">
					</div>
					<div class="service-text">
						<h4><a href="service-single.html">Transport & Logistics Consulting</a></h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem dolorem dicta libero veritatis reiciendis quis pariatur magni.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="single-service-item">
					...
					<div class="service-left-bg"></div>
					<div class="service-icon">
						<img src="<?php echo site_url('assets/images/icons/service-5.png')?>" alt="">
					</div>
					<div class="service-text">
						<h4><a href="service-single.html">Financial Services Consulting</a></h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem dolorem dicta libero veritatis reiciendis quis pariatur magni.</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
				<div class="single-service-item">
					...
					<div class="service-left-bg"></div>
					<div class="service-icon">
						<img src="<?php echo site_url('assets/images/icons/service-6.png')?>" alt="">
					</div>
					<div class="service-text">
						<h4><a href="service-single.html">Travel and Aviation Consulting</a></h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem dolorem dicta libero veritatis reiciendis quis pariatur magni.</p>
					</div>
				</div>
			</div>
		...
		<div class="item-list">
			<div class="row">
				...
				<div class="col-md-5 col-sm-10 col-xs-12">
					<div class="item">
						<figure class="image-box">
							<img src="<?php echo site_url('assets/images/about/1.jpg')?>" alt="" />
						</figure>
					</div>
				</div>
			</div>
		...
		<div class="how-one-container">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="how-box-one" style="background: linear-gradient(rgba(3, 61, 117, 0.9),rgba(3, 61, 117, 0.9)),url(images/news/1.jpg);">
					<div class="inner-box">
						<div class="icon-box">
							<img src="<?php echo site_url('assets/images/icons/how-1.png')?>" alt="">
						</div>
			...
			<!--how it work Box-->
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="how-box-one" style="background: linear-gradient(rgba(3, 61, 117, 0.9),rgba(3, 61, 117, 0.9)),url(images/news/2.jpg);">
					<div class="inner-box">
						<div class="icon-box">
							<img src="<?php echo site_url('assets/images/icons/how-2.png')?>" alt="">
						</div>
			...
			<!--how it work Box-->
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="how-box-one" style="background: linear-gradient(rgba(3, 61, 117, 0.9),rgba(3, 61, 117, 0.9)),url(images/news/3.jpg);">
					<div class="inner-box">
						<div class="icon-box">
							<img src="<?php echo site_url('assets/images/icons/how-3.png')?>" alt="">
						</div>
...
<section class="get-quote-section" style=" background-image:url(<?php echo site_url('assets/images/resources/getquote-bg-img.jpg')?>);">
	<div class="container">
		<div class="row clearfix">
			...
			<div class="form-column col-lg-7 col-md-8 col-sm-12 col-xs-12">
				...
				<div class="form-box default-form">
					<form method="post" action="https://shr-business.netlify.app/php/form-to-email.php">
			...
			<div class="image-column col-lg-5 col-md-4 col-sm-12 col-xs-12">
				<figure class="image"><img src="<?php echo site_url('assets/images/resources/man-with-tab.png')?>" alt=""></figure>
			</div>
	...
	<div class="container">
		...
		<div class="team-carousel">
			<div class="single-team">
				<img src="<?php echo site_url('assets/images/team/team-1.jpg')?>"  alt="">
			...
			<div class="single-team">
				<img src="<?php echo site_url('assets/images/team/team-2.jpg')?>"  alt="">
				<div class="team-content">
					<h3 class="title">David Nicholson</h3>
					<span class="post">Businesss Consultant</span>
				</div>
			...
			<div class="single-team">
				<img src="<?php echo site_url('assets/images/team/team-3.jpg')?>"  alt="">
				<div class="team-content">
					<h3 class="title">David Nicholson</h3>
					<span class="post">Businesss Consultant</span>
				</div>
			...
			<div class="single-team">
				<img src="<?php echo site_url('assets/images/team/team-4.jpg')?>"  alt="">
				<div class="team-content">
					<h3 class="title">David Nicholson</h3>
					<span class="post">Businesss Consultant</span>
				</div>
...
<section class="countup-section bg-image" style="background-image: url(<?php echo site_url('assets/images/background/bg-1.jpg')?>); background-attachment: fixed;">
	<div class="container">
		<div class="row">
			<div class="col-sm-3 col-6">
				<div class="text-center single_block">
					<div class="icon-box">
						<img class="counter-icon" src="<?php echo site_url('assets/images/icons/count-1.png')?>" alt="">
					</div>
			...
			<div class="col-sm-3 col-6">
				<div class="text-center single_block">
					<div class="icon-box">
						<img class="counter-icon" src="<?php echo site_url('assets/images/icons/count-2.png')?>" alt="">
					</div>
			...
			<div class="col-sm-3 col-6">
				<div class="text-center single_block">
					<div class="icon-box">
						<img class="counter-icon" src="<?php echo site_url('assets/images/icons/count-3.png')?>" alt="">
					</div>
			...
			<div class="col-sm-3 col-6">
				<div class="text-center single_block">
					<div class="icon-box">
						<img class="counter-icon" src="<?php echo site_url('assets/images/icons/count-4.png')?>" alt="">
					</div>
		...
		<div class="latest-news-carousel owl-carousel owl-theme">
			...
			<div class="news-post">
				<div class="news-post-image">
					...
					<img src="<?php echo site_url('assets/images/news/1.jpg')?>" alt="Image" class="img-responsive">
				</div>
			...
			<div class="news-post">
				<div class="news-post-image">
					<div class="news-overlay"></div>
					<div class="news-category"><a href="#">Investments</a></div>
					<img src="<?php echo site_url('assets/images/news/2.jpg')?>" alt="Image" class="img-responsive">
				</div>
				<div class="news-post-text">
					<h3><a href="#">Why buying a big house is a bad investment</a></h3>
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts...</p>
				</div>
				<div class="news-post-meta">
					<a href="#"><i class="fa fa-user"></i>Admin</a>
			...
			<div class="news-post">
				<div class="news-post-image">
					<div class="news-overlay"></div>
					<div class="news-category"><a href="#">Planning</a></div>
					<img src="<?php echo site_url('assets/images/news/3.jpg')?>" alt="Image" class="img-responsive">
				</div>
				<div class="news-post-text">
					<h3><a href="#">Strategic and commercial approach with issues</a></h3>
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts...</p>
				</div>
				<div class="news-post-meta">
					<a href="#"><i class="fa fa-user"></i> Admin</a>
