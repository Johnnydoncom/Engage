		...
		<div class="item-list">
			<div class="row">
				...
				<div class="col-md-7 col-sm-12 col-xs-12">
					<div class="sec-title">
						<h2 class="left">About Business</h2>
	...
	<div class="container text-center">
		...
		<div class="how-one-container">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="how-box-one" style="background: linear-gradient(rgba(3, 61, 117, 0.9),rgba(3, 61, 117, 0.9)),url(<?php echo site_url('assets/images/news/1.jpg');?>">
					<div class="inner-box">
						<div class="icon-box">
